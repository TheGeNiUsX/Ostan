...
(function () {
  const dictionary = {
    en: {
      ...
      perm_sec_saudi: "🇸🇦 Saudi Staff & Payroll Hub",
      perm_saudi_view: "View Saudi Staff & Payroll",
      perm_saudi_create: "Add Saudi Employee (+)",
      perm_saudi_edit: "Edit Saudi Profile & Salary",
      perm_saudi_delete: "Delete Saudi Employee",
      perm_saudi_excel: "Excel Batch Import / Export",
      ...
      tab_login: "Sign In",
      auth_admin_only_note: "Account access is provisioned by organization administration only.",
      label_worker_password: "Account Password (Given to Employee) *",
      btn_gen_password: "Generate Password",
      btn_copy_credentials: "Copy Login Credentials",
      credentials_copied: "Credentials Copied to Clipboard",
      modal_cred_title: "Employee Account Created!",
      modal_cred_subtitle: "Self sign-up is disabled. Give these login credentials directly to the employee:",
      ...
      whatsapp_api_config_btn: "⚙️ Meta API Settings",
      whatsapp_api_status_active: "🟢 Meta Cloud API: Active",
      whatsapp_api_status_web: "🟠 WhatsApp Web Mode",
      whatsapp_api_modal_title: "⚙️ Meta WhatsApp Business Cloud API Configuration",
      whatsapp_api_modal_desc: "Directly link your official Meta WhatsApp Cloud API credentials to dispatch instant background messages without opening browser tabs.",
      label_phone_number_id: "Meta Phone Number ID *",
      label_waba_id: "WhatsApp Business Account ID (WABA ID)",
      label_access_token: "Permanent Access Token (System User Token) *",
      label_sender_mode: "Default Dispatch Engine:",
      opt_mode_api: "⚡ Meta Cloud API (Direct & Instant Background)",
      opt_mode_web: "🌐 WhatsApp Web (Browser Runner)",
      btn_test_api: "⚡ Test Meta API Connection",
      btn_save_api: "💾 Save API Configuration",
      btn_setup_guide_meta: "📘 Step-by-Step Meta Setup Guide",
      meta_api_guide_title: "📘 How to get your Meta WhatsApp Cloud API Credentials",
      meta_api_guide_step1: "1. Go to developers.facebook.com and create a Meta App with 'Business' type.",
      meta_api_guide_step2: "2. Under 'Add products to your app', click Set Up on WhatsApp.",
      meta_api_guide_step3: "3. Copy your 'Phone Number ID' and 'WhatsApp Business Account ID' from the API Setup dashboard.",
      meta_api_guide_step4: "4. Generate a Permanent System User Token in Business Settings > System Users with 'whatsapp_business_messaging' permission.",
      meta_api_guide_step5: "5. Paste them below and click 'Test Meta API Connection'. Enjoy 1,000 free conversations every month!",
      btn_start_cloud_api_dispatch: "⚡ Send Instantly via Meta Cloud API",
    ...
    ar: {
      ...
      nav_saudi_staff: "الكادر السعودي",
      ...
      perm_sec_saudi: "🇸🇦 الكادر الوطني وإدارة الرواتب",
      perm_saudi_view: "استعراض ورؤية الكادر والرواتب",
      perm_saudi_create: "إضافة موظف سعودي (+)",
      perm_saudi_edit: "تعديل موظف سعودي والراتب",
      perm_saudi_delete: "حذف موظف سعودي",
      perm_saudi_excel: "استيراد وتصدير إكسل",
      ...
      auth_admin_only_note: "حسابات الدخول تصدر وتدار حصرياً من قبل إدارة المنشأة.",
      label_worker_password: "كلمة مرور الحساب (تسلم للموظف) *",
      btn_gen_password: "توليد كلمة مرور",
      btn_copy_credentials: "نسخ بيانات الدخول",
      credentials_copied: "تم نسخ بيانات الدخول إلى الحافظة",
      modal_cred_title: "تم إنشاء حساب الموظف بنجاح!",
      modal_cred_subtitle: "التسجيل الذاتي ملغي. يرجى تسليم بيانات تسجيل الدخول هذه للموظف مباشرة:",
      ...
      // Meta WhatsApp Cloud API
      whatsapp_api_config_btn: "⚙️ إعدادات Meta API",
      whatsapp_api_status_active: "🟢 Meta Cloud API: متصل ونشط",
      whatsapp_api_status_web: "🟠 وضع واتساب ويب",
      whatsapp_api_modal_title: "⚙️ إعدادات Meta WhatsApp Business Cloud API",
      whatsapp_api_modal_desc: "اربط بيانات اعتماد Meta WhatsApp Cloud API الرسمية لإرسال الرسائل المؤتمتة فورياً في الخلفية بدون فتح نوافذ متصفح.",
      label_phone_number_id: "معرّف رقم الهاتف (Phone Number ID) *",
      label_waba_id: "معرّف حساب الأعمال (WABA ID)",
      label_access_token: "رمز الوصول الدائم (Permanent Access Token) *",
      label_sender_mode: "محرك الإرسال الافتراضي:",
      opt_mode_api: "⚡ Meta Cloud API (إرسال فوري ومباشر بالخلفية)",
      opt_mode_web: "🌐 واتساب ويب (عبر المتصفح)",
      btn_test_api: "⚡ اختبار اتصال Meta API",
      btn_save_api: "💾 حفظ إعدادات الـ API",
      btn_setup_guide_meta: "📘 دليل إعداد Meta خطوة بخطوة",
      meta_api_guide_title: "📘 كيفية استخراج بيانات Meta WhatsApp Cloud API",
      meta_api_guide_step1: "١. توجّه إلى developers.facebook.com وأنشئ تطبيقاً جديداً من نوع 'Business'.",
      meta_api_guide_step2: "٢. أضف منتج 'WhatsApp' إلى التطبيق بالضغط على إعداد (Set Up).",
      meta_api_guide_step3: "٣. انسخ معرّف رقم الهاتف (Phone Number ID) ومعرّف حساب واتساب للأعمال (WABA ID) من لوحة API Setup.",
      meta_api_guide_step4: "٤. أنشئ رمز وصول دائم من Business Settings > System Users مع صلاحية 'whatsapp_business_messaging'.",
      meta_api_guide_step5: "٥. الصق البيانات هنا واضغط 'اختبار اتصال Meta API'. تمتع بـ 1,000 محادثة مجانية شهرياً!",
      btn_start_cloud_api_dispatch: "⚡ إرسال فوري عبر Meta Cloud API",
