...
(function () {
  const dictionary = {
    en: {
      ...
      dispatch_runner_info: "WhatsApp Web puts the message in the chat box and requires pressing Enter or the green send button. The runner will automatically count down and advance to the next recipient after your chosen delay.",
    ...
    ar: {
      ...
      dispatch_runner_info: "سياسة أمان واتساب تضع الرسالة في صندوق المحادثة وتتطلب الضغط على Enter أو زر الإرسال الأخضر. سيقوم النظام بعد ذلك بالعد التنازلي التلقائي وفتح المستلم التالي بأمان دون التعرض للحظر.",
